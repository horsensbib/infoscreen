		...
		<div id="content" class="site-content" role="main">
			...
			<article id="post-0" class="post error404 not-found">
				...
				<div class="entry-content">
					...
					<div class="widget">
						<h2 class="widgettitle"><?php _e( 'Most Used Categories', 'infoscreen' ); ?></h2>
						<ul>
					...
					$archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', 'infoscreen' ), convert_smilies( ':)' ) ) . '</p>';
